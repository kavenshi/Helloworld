...
data = {
    'username': '18001073002', #替换为自己账户的用户名
    'password': '19901208peng', #替换为自己账户的密码
    'execution': execution,
    '_eventId': 'submit',
    'lt': lt,
    'verifyCode': '',
...
#'username=18001073002&redirect=&password=19901208peng&_eventId=submit&verifyCode=&lt=LT-1035868-wtLynpaoj62GkOpaHYYvtVNw9WZeZy-www.lianjia.com&execution=e1s1'
headers = {
    'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
